...
public class RedisUtils {
    ...
    public boolean setValue(String key, Object value) {
        try {
            ...
            logger.error("向redis中存入值时异常-->{}", e.getMessage());
            return false;
        }
    }
    ...
    public boolean setValueTime(String key, Object value, long time) {
        try {
            ...
            logger.error("设置缓存并指定过期时间异常-->{}", e.getMessage());
            return false;
        }
    }
    ...
    public boolean haskey(String key) {
        try {
            ...
            logger.error("redis值不存在-->{}", e.getMessage());
            return false;
        }
    }
    ...
    public boolean expire(String key, long time) {
        try {
            ...
            logger.error("给旧的缓存设置新的过期时间异常--> {}", e.getMessage());
            return false;
        }
    }
